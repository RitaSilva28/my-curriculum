...
export default function Education(){
    ...
    return (
        <div  id="education">
<h1> <span className="title white-font">Where did I learn?<img class="trace" src={Trace2} alt="underline draw"/></span></h1>    
...
<a href="https://mobwiser.com/" className="educator-container mobwiser col" target={"_blank"}  rel="noreferrer" >

  <img className="logo-image" src={MobwiserLogo} alt="mobwiser logo"/>
  <h5>Mobwiser Bootcamp</h5>
  <p>2020-2021</p>
  </a>

  <a href="https://www.shecodes.io/certificates/6539a22d348e23df9f0edcea35c6a7bc" className="educator-container  col" target={"_blank"}  rel="noreferrer" >
  <img className="logo-image" src={SCBasics} alt="shecodes basics logo"/>
  ...
  <a href="https://www.shecodes.io/certificates/018ac3099007fea58ed354574cebd784" className="educator-container col" target={"_blank"}  rel="noreferrer" >
  <img className="logo-image" src={SCReact} alt="shecodes react logo" />
